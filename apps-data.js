...
const APPS = [
  ...
  {
    id: "quicknotes-ks3-geography-coasts",
    title: "Coasts & Coastal Processes Quick Notes",
    tagline: "A clear KS3 study guide to coastal processes and landforms.",
    description: "A concise KS3 Geography study guide to coasts, covering key processes, coastal landforms and named case studies, with key vocabulary and a quick quiz to check understanding.",
    category: "quicknotes",
    subject: "Geography",
    audience: "KS3 Geography students",
    tier: "free",
    price: "Free",
    gumroadUrl: "",
    fileUrl: "quick-notes/ks3-geography-coasts.html",
    fileType: "app",
    image: "images/quicknotes-ks3-geography-coasts.jpg",
    icon: "book",
    featured: false,
    isNew: true,
    comingSoon: false,
    features: ["Key knowledge organised by year group", "Coastal processes and landforms explained", "Key vocabulary and common mistakes to avoid", "Quick quiz to check understanding", "Opens instantly in a new browser tab"],
    worksOffline: true,
    noAccount: true
  },
  {
    id: "quicknotes-ks3-geography-map-skills",
    title: "Map Skills & Grid References Quick Notes",
    tagline: "A clear KS3 study guide to map skills and grid references.",
    description: "A concise KS3 Geography study guide to map skills, covering grid references, map symbols and key techniques, with key vocabulary and a quick quiz to check understanding.",
    category: "quicknotes",
    subject: "Geography",
    audience: "KS3 Geography students",
    tier: "free",
    price: "Free",
    gumroadUrl: "",
    fileUrl: "quick-notes/ks3-geography-map-skills.html",
    fileType: "app",
    image: "images/quicknotes-ks3-geography-map-skills.jpg",
    icon: "book",
    featured: false,
    isNew: true,
    comingSoon: false,
    features: ["Key map skills organised by year group", "Grid references and map symbols explained clearly", "Key vocabulary and common mistakes to avoid", "Quick quiz to check understanding", "Opens instantly in a new browser tab"],
    worksOffline: true,
    noAccount: true
  },
  {
    id: "quicknotes-ks3-geography-population",
    title: "Population & Urbanisation Quick Notes",
    tagline: "A clear KS3 study guide to population and urbanisation.",
    description: "A concise KS3 Geography study guide to population and urbanisation, covering key patterns and processes, with key vocabulary and a quick quiz to check understanding.",
    category: "quicknotes",
    subject: "Geography",
    audience: "KS3 Geography students",
    tier: "free",
    price: "Free",
    gumroadUrl: "",
    fileUrl: "quick-notes/ks3-geography-population.html",
    fileType: "app",
    image: "images/quicknotes-ks3-geography-population.jpg",
    icon: "book",
    featured: false,
    isNew: true,
    comingSoon: false,
    features: ["Key knowledge organised by year group", "Population and urbanisation patterns and processes", "Key vocabulary and common mistakes to avoid", "Quick quiz to check understanding", "Opens instantly in a new browser tab"],
    worksOffline: true,
    noAccount: true
  },
  {
    id: "quicknotes-ks3-geography-rivers",
    title: "Rivers & Flooding Quick Notes",
    tagline: "A clear KS3 study guide to rivers and flooding.",
    description: "A concise KS3 Geography study guide to rivers and flooding, covering key processes and landforms, with key vocabulary and a quick quiz to check understanding.",
    category: "quicknotes",
    subject: "Geography",
    audience: "KS3 Geography students",
    tier: "free",
    price: "Free",
    gumroadUrl: "",
    fileUrl: "quick-notes/ks3-geography-rivers.html",
    fileType: "app",
    image: "images/quicknotes-ks3-geography-rivers.jpg",
    icon: "book",
    featured: false,
    isNew: true,
    comingSoon: false,
    features: ["Key knowledge organised by year group", "River processes and landforms explained", "Key vocabulary and common mistakes to avoid", "Quick quiz to check understanding", "Opens instantly in a new browser tab"],
    worksOffline: true,
    noAccount: true
  },
  {
    id: "quicknotes-ks3-geography-weather",
    title: "Weather & Climate Quick Notes",
    tagline: "A clear KS3 study guide to weather and climate.",
    description: "A concise KS3 Geography study guide to weather and climate, covering key processes and patterns, with key vocabulary and a quick quiz to check understanding.",
    category: "quicknotes",
    subject: "Geography",
    audience: "KS3 Geography students",
    tier: "free",
    price: "Free",
    gumroadUrl: "",
    fileUrl: "quick-notes/ks3-geography-weather.html",
    fileType: "app",
    image: "images/quicknotes-ks3-geography-weather.jpg",
    icon: "book",
    featured: false,
    isNew: true,
    comingSoon: false,
    features: ["Key knowledge organised by year group", "Weather and climate processes and patterns", "Key vocabulary and common mistakes to avoid", "Quick quiz to check understanding", "Opens instantly in a new browser tab"],
    worksOffline: true,
    noAccount: true
  }
