...
const APPS = [
...

  {
    ...
    fileUrl: "/teacher-apps/report-writer-lite.html",
    fileType: "app",
...

  {
    ...
    description: "Everything in the free version, plus extra banks of subject-specific phrasing, saved pupil profiles and faster batch report-writing for a full class.",
    category: "teacher",
    subject: "General",
  ...
  },
  {
    ...
    description: "Everything in the free version, plus scheme-of-work views, saved templates by topic, and more advanced options for planning across a full term.",
    category: "teacher",
    subject: "General",
...

  {
    ...
    fileUrl: "/teacher-apps/mark-my-class-lite.html",
    fileType: "app",
  ...
  },
  {
    ...
    fileUrl: "/teacher-apps/differentiator.html",
    fileType: "app",
...

  {
    ...
    description: "Everything in the free version, plus deeper analysis of pupil assessment marks — spot class-wide misconceptions and generate reteach priorities in seconds.",
    category: "teacher",
    subject: "General",
  ...
  },
  {
    ...
    fileUrl: "/teacher-apps/feedback-fixer-lite.html",
    fileType: "app",
  ...
  },
  {
    ...
    description: "Everything in the free version, plus class lists, batch feedback for a whole class, 8 more subjects, SEND/EAL/High Attainer support, multiple feedback formats, editable saved history and class print sheets.",
    category: "teacher",
    subject: "General",
  ...
  },
  {
    ...
    fileUrl: "/teacher-apps/task-twist-lite.html",
    fileType: "app",
  ...
  },
  {
    ...
    description: "Everything in the free version, plus six differentiation levels, SEND/EAL/Greater Depth profiles, individual pupil versions, a class differentiation planner, editable success criteria and questioning prompts, printable task cards, a Classroom Display mode and saved tasks.",
    category: "teacher",
    subject: "General",
...

  {
    ...
    fileUrl: "/teacher-apps/rubric-generator.html",
    fileType: "app",
  ...
  },
  {
    ...
    description: "Everything in the free version, plus up to 8 editable criteria, custom grade-level labels, criterion weightings, CSV export and saved rubrics you can reload for next time.",
    category: "teacher",
    subject: "General",
  ...
  {
    id: "ks1-morning-starter",
    title: "KS1 Morning Starter Generator",
    tagline: "A ready-to-use start-of-day activity for Year 1 and Year 2 in seconds.",
    description: "Generate a quick KS1 morning starter for English, maths or a mix of both, with a choice of difficulty, an optional challenge question, and an answer key you can reveal on demand.",
    category: "teacher",
    subject: "Primary",
    audience: "Year 1 and Year 2 teachers",
    tier: "lite",
    price: "Free",
    gumroadUrl: "",
    fileUrl: "/teacher-apps/ks1-morning-starter.html",
    fileType: "app",
    image: "/images/early-years/mascot-cheer.png",
    featured: false,
    isNew: true,
    comingSoon: false,
    features: [
      "Year 1, Year 2 or Mixed KS1, across English, maths or a mix of both",
      "Gentle Start, Standard or Challenge difficulty, with 5, 8 or 10 questions",
      "Optional bonus challenge question and a reveal-on-demand answer key",
      "Maths answers are calculated from the same numbers shown in each question",
      "Regenerate, copy or print an ink-friendly worksheet"
    ],
    worksOffline: true,
    noAccount: true
  },
  {
    id: "phonics-activity-generator",
    title: "Phonics Activity Generator",
    tagline: "A quick phonics activity for Early Years and KS1, built around one target sound.",
    description: "Generate sound spotting, word sort, real-or-alien, missing sound, build-the-word and sentence spotter activities for a chosen grapheme, with original alien words and an optional answer key.",
    category: "teacher",
    subject: "Primary",
    ...
    price: "Free",
    gumroadUrl: "",
    fileUrl: "/teacher-apps/phonics-activity-generator.html",
    fileType: "app",
    image: "/images/early-years/mascot-cheer.png",
    featured: false,
    isNew: true,
    comingSoon: false,
    features: [
      "16 common graphemes, from 'sh' and 'ch' to 'ear' and 'air', or Mixed sounds",
      "Seven activity types, including Sound Spotting, Real or Alien? and Quick Mix",
      "Original, hand-checked alien (pseudo) words — never copied from official screening materials",
      "Early Years, Year 1, Year 2 or Mixed KS1 levels",
      "Reveal-on-demand answers, plus copy and print"
    ],
    worksOffline: true,
    noAccount: true
  },
  {
    id: "early-finisher-generator",
    title: "Early Finisher Generator",
    tagline: "Instant, meaningful tasks for pupils who finish early.",
    description: "Generate a single early-finisher activity, or three options at once, across English, maths, thinking skills and creative tasks — matched to year group, available time and activity style.",
    category: "teacher",
    subject: "Primary",
    audience: "Early Years and KS1 teachers",
    tier: "lite",
    price: "Free",
    gumroadUrl: "",
    fileUrl: "/teacher-apps/early-finisher-generator.html",
    fileType: "app",
    image: "/images/early-years/mascot-cheer.png",
    featured: false,
    isNew: true,
    comingSoon: false,
    features: [
      "Early Years, Year 1, Year 2 or Mixed KS1, across four categories plus Mixed",
      "5, 10 or 15 minute tasks, matched to Quiet, Partner, No-writing or Pencil-and-paper styles",
      "Optional extension task included with most activities",
      "Generate one activity or three options for pupils to choose from",
      "Copy or print, no account needed"
    ],
    worksOffline: true,
    noAccount: true
  },
