...
const ICONS = {
  ...
  facebook: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M13.8 8.2h1.6V5.6h-1.9c-1.9 0-3 1.1-3 3v1.7h-1.8v2.6h1.8V18h2.5v-5.1h1.9l.3-2.6h-2.2v-1.3c0-.5.2-.8.8-.8z" fill="currentColor" stroke="none"/></svg>',
  pinterest: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M10.2 18c.3-1 .9-3.7.9-3.7s.4.8 1.6.8c2.1 0 3.6-1.9 3.6-4.3 0-2.3-1.9-4-4.4-4-3.1 0-4.7 2.1-4.7 4.4 0 1.1.6 2.4 1.5 2.8.1.1.2 0 .3-.1l.2-.9c0-.1 0-.2-.1-.3-.3-.4-.5-1-.5-1.6 0-1.5 1.1-2.9 3-2.9 1.6 0 2.7 1.1 2.7 2.7 0 1.8-.9 3.1-2.2 3.1-.7 0-1.2-.6-1.1-1.3.2-.9.6-1.9.6-2.6 0-.6-.3-1.1-1-1.1-.8 0-1.4.8-1.4 1.9 0 .7.2 1.2.2 1.2s-.8 3.2-.9 3.8c-.2.9-.1 2 0 2.5" fill="currentColor" stroke="none"/></svg>'
};
